...
const kittenThree = '<li class="card"><img class="card_img" src="https://dev.adalab.es/maine-coon-cat.webp" alt="maine-coon-cat" /> <h3 class="card_title">Cielo</h3> <h4 class="card_race">Maine Coon</h4> <p class="card_description"> Tienen la cabeza cuadrada y los ojos simétricos, por lo que su bella mirada se ha convertido en una de sus señas de identidad. Sus ojos son grandes y las orejas resultan largas y en punta. </p> </li> </ul>';
box.innerHTML = kittenOne + kittenTwo + kittenThree;

//KITTEN ONE
const kittenOneImg = 'src="https://dev.adalab.es/gato-siames.webp" alt="siames-cat" ' ;
...
//KITTEN TWO
const kittenTwoImg = ' src="https://dev.adalab.es/sphynx-gato.webp" alt="sphynx-cat" ';
...
//KITTEN THREE
const kittenThreeImg = 'src="https://dev.adalab.es/maine-coon-cat.webp" alt="maine-coon-cat"';
